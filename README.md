...
func upper(ella string) string {
	return strings.ToUpper(ella)

}
func lower(milo string) string {
	return strings.ToLower(milo)
}

func reverse(ene string) string {
	r := []rune(ene)
